...
sys.path.insert(0, os.path.abspath(os.path.join(binpath, 'Development/pymodules')))
sys.path.insert(0, os.path.abspath(os.path.join(binpath, 'Release/pymodules')))

# Add the build paths to PATH so renderdoc.dll can be located
os.environ["PATH"] += os.pathsep + os.path.abspath(os.path.join(binpath, 'Release/'))
os.environ["PATH"] += os.pathsep + os.path.abspath(os.path.join(binpath, 'Development/'))

if sys.platform == 'win32' and sys.version_info[1] >= 8:
    if os.path.exists(os.path.join(binpath, 'Release/')):
        os.add_dll_directory(os.path.abspath(os.path.join(binpath, 'Release/')))
    if os.path.exists(os.path.join(binpath, 'Development/')):
        os.add_dll_directory(os.path.abspath(os.path.join(binpath, 'Development/')))
